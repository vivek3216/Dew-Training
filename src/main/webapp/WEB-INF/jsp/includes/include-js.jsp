...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script src="${ pageContext.request.contextPath }/static/js/counterup.min.js"></script>
  <script src="${ pageContext.request.contextPath }/static/js/owl.carousel.min.js"></script>
  <script src="${ pageContext.request.contextPath }/static/js/isotope.pkgd.min.js"></script>
  <script src="${ pageContext.request.contextPath }/static/js/lightbox.min.js"></script>
  <!-- Contact Form JavaScript File -->
  <script src="${ pageContext.request.contextPath }/static/js/contactform.js"></script>
